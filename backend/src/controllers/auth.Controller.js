...
export const register = asyncHandler(async (req, res) => {
  const { email, password, full_name, department, employee_id, mobile_number } =
    req.body;
...
export const updateProfile = asyncHandler(async (req, res) => {
  const { full_name, department, employee_id, mobile_number, profile_photo } =
    req.body;
  ...
  if (req.body.office_end_time !== undefined)
    user.office_end_time = req.body.office_end_time;
  if (req.body.half_day_hours !== undefined)
    user.half_day_hours = req.body.half_day_hours;
  if (req.body.office_start_time !== undefined)
    user.office_start_time = req.body.office_start_time;
  if (req.body.office_end_time !== undefined)
    user.office_end_time = req.body.office_end_time;
  if (req.body.late_threshold_minutes !== undefined)
    user.late_threshold_minutes = req.body.late_threshold_minutes;
  if (req.body.half_day_hours !== undefined)
    user.half_day_hours = req.body.half_day_hours;
