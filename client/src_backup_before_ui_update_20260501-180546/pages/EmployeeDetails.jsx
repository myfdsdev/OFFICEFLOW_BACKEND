...
export default function EmployeeDetails() {
  ...
  const displayPresentDays = analyticsStats?.presentDays ?? presentDays;
  const displayTotalHours = analyticsStats?.totalHoursMonth ?? totalHours.toFixed(1);
  const displayAbsentDays = analyticsStats?.absentDays ?? absentDays;
  const displayLeaves = analyticsStats?.totalLeavesTaken ?? approvedLeaves;
                ...
                <div className="grid md:grid-cols-4 gap-3">
                  <div className="rounded-xl bg-gray-50 p-4">
                    ...
                    <p className="text-2xl font-bold text-gray-900">
                      {analytics.stats.attendancePercentage}%
                    </p>
                  </div>
                  <div className="rounded-xl bg-gray-50 p-4">
                    <p className="text-sm text-gray-500">Avg Hours</p>
                    <p className="text-2xl font-bold text-gray-900">
                      {analytics.stats.averageHoursPerDay}h
                    </p>
                  </div>
                  <div className="rounded-xl bg-gray-50 p-4">
                    <p className="text-sm text-gray-500">Overtime</p>
                    <p className="text-2xl font-bold text-gray-900">
                      {analytics.stats.overtimeHours}h
                    </p>
                  </div>
                  <div className="rounded-xl bg-gray-50 p-4">
                    <p className="text-sm text-gray-500">Score</p>
                    <p className="text-2xl font-bold text-gray-900">
                      {analytics.stats.performanceScore}
                    </p>
                  </div>
                </div>
              </CardContent>
