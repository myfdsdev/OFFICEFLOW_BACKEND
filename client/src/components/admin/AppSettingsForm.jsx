...
import { Upload, Save, Image as ImageIcon, Type, Palette } from 'lucide-react';
...
      <div className="flex justify-end gap-3 pt-2">
        {isDirty && (
          <Button variant="outline" onClick={handleReset} disabled={saving} className="bg-lime-400 text-black ">
            Reset Changes
          </Button>
        )}
        <Button
